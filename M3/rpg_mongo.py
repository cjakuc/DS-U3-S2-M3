...
# Working with MongoDB was primarily different from working with PostgreSQL because of two things. First of all, 
# MongoDB does not require the explicit specification of data types for the creation of a collection, the
# equivalent of a table in PostgreSQL. Secondly, MongoDB's insert function, used to put data into a colelction, 
# expects a dictionary whereas PostgreSQL's equivalent expects a tuple. Because MongoDB has less explicit requirement,
